...
extern int32_t EE_LoRa_Init(int32_t format,
...
extern int32_t EE_LoRa_Read(int32_t bank, uint16_t addr, uint32_t *data);
...
extern int32_t EE_LoRa_Write(int32_t bank, uint16_t addr, uint32_t data);
...
extern int32_t EE_LoRa_Clean(int32_t bank, int32_t interrupt);
