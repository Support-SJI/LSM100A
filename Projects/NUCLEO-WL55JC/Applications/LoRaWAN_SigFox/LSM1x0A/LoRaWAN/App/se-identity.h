...
/* Unsigned Type*/
typedef unsigned char       lora_u8;
typedef unsigned short      lora_u16;
typedef unsigned long       lora_u32;
typedef unsigned char       lora_bool;
/* Signed Type */
typedef signed char         lora_s8;
typedef signed short        lora_s16;
typedef signed long         lora_s32;
/* Custom Types */
typedef unsigned short      lora_error_t;
...
#define LORA_APPEUI_WORD_0          						(lora_u32)0x01010101
