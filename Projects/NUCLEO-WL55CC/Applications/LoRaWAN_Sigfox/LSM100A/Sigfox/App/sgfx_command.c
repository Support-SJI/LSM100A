...
static const struct ATCommand_s ATCommand[] =
{
...
#endif /* !NO_HELP */
    .get = AT_selection_get,
    .set = AT_selection_set,
    .run = AT_return_error,
  },
  ...
  {
    .string = AT_RL,
    .size_string = sizeof(AT_RL) - 1,
  #ifndef NO_HELP
    .help_string = "AT"AT_RL" Starts listening for a local loop \r\n",
  #endif /* !NO_HELP */
    .get = AT_return_error,
    .set = AT_test_rl,
    .run = AT_return_error,
  ...
  {
    .string = AT_SL,
    .size_string = sizeof(AT_SL) - 1,
  #ifndef NO_HELP
    .help_string = "AT"AT_SL" Send Tx packet for a local loop \r\n",
  #endif /* !NO_HELP */
    .get = AT_return_error,
    .set = AT_test_sl,
    .run = AT_return_error,
