...
/*!******************************************************************
  * \fn sfx_u8 RF_API_get_version(int32_t freq, uint32_t dataRate, uint8_t *data_buffer, int data_len)
  * \brief Send tx packet to local loop
  *
  * \param[out] int32_t freq                     DL center frequency
  * \param[out] uint32_t dataRate                DL data rate
  * \param[out] uint8_t *data_buffer             Pointer to Byte array (ASCII format)
  * \param[out] int data_len                     Size of the byte array
  *
  * \retval SFX_ERR_NONE:                No error
  *******************************************************************/
